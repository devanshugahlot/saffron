  ...
  return (
    <div>
      <main>
        <a
          target="_blank"
          href="https://api.whatsapp.com/send?phone=917300042095&text=%20I%20want%20Online%20Cricket%20ID%20with%2010%25%20Extra%20bonus%20Source%3A-%20MMC%2C%20AD"
          className="enq-side-btn-icone"
        >
          <i className="fab fa-whatsapp" /> Click Here to Get ID
        </a>
              ...
              <div className="col-xl-9">
                <div className="slider-content text-center">
                  <div className="logo">
                    ...
                    >
                      <img
                        src="./images/saffronexch-logo.jpg"
                        alt="Logo"
                        width="200px"
                      />
                    </a>
                  ...
                  <h6 className="wow fadeInDown" data-wow-delay=".2s">
                    Saffron Exch [10 साल का भरोसा] - Get your Trusted Fantasy
                    Sport
                  </h6>
                  <h2
                    style={{ color: "white " }}
                  ...
                  <p className="wow fadeInUp" data-wow-delay="2s">
                    ...
                    Create your Account within 2 minutes! Join Most Trusted,
                    Secure &amp; Fastest Fantasy Sport of India.
                  </p>
                  <a
                    target="_blank"
                    href="https://api.whatsapp.com/send?phone=917300042095&text=%20I%20want%20Online%20Cricket%20ID%20with%2010%25%20Extra%20bonus%20Source%3A-%20MMC%2C%20AD"
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                <div
                  style={{ background: "#FFE4C9" }}
                  className="game-single-content"
                >
                    ...
                    <div className="uc-game-head-title">
                      <h4>
                        ...
                        <span style={{ color: "red" }}>
                          Saffron "Khelo Dil and Dimag Se" - Oldest Fantasy
                          Sports provider
                        </span>
                      </h4>
                    </div>
                  ...
                  <div className="footer-widget mb-50">
                    ...
                    <div className="footer-social">
                      <ul>
                        <li>
                          <a href="https://api.whatsapp.com/send?phone=917300042095&text=%20I%20want%20Online%20Cricket%20ID%20with%2010%25%20Extra%20bonus%20Source%3A-%20MMC%2C%20AD">
                            <FaWhatsapp />
                          </a>
                        </li>
                      </ul>
